...
plt.plot(KEvals,dpvals05,'-',color='b' ,lw=3,label='$\Delta_p/dx$ @ 0.5 cm')
plt.plot(KEvals,dpvals03,'--',color='b',lw=3,label='$\Delta_p/dx$ @ 0.3 cm')
plt.plot(KEvals,dpvals30,'-.',color='b',lw=3,label='$\Delta_p/dx$ @ 3.0 cm')
plt.plot(KEvals,dedxvals,color='r',lw=2,label='$\langle dE/dx\\rangle$')
plt.grid(which='both')
